...
const routes = [
  ...
  { path: '/stats-calculator/', h1: 'Palworld Stats Calculator', title: 'Palworld Stats Calculator - Estimate Pal Stats by Level', description: 'Estimate Palworld stats by Pal, level, modifiers, and IV context with clear formula and data-version caveats.', ogTitle: 'Palworld Stats Calculator', ogDescription: 'Preview Palworld stat calculator inputs and expected stat-band requirements.', robots: 'index,follow' },
  { path: '/passive-skill-calculator/', h1: 'Palworld Passive Skill Calculator', title: 'Palworld Passive Skill Calculator - Plan Breeding Passives', description: 'Plan Palworld passive skills for breeding with RNG caveats, desired passive inputs, and no unsupported probability claims.', ogTitle: 'Palworld Passive Skill Calculator', ogDescription: 'Plan Palworld passive-skill targets with transparent inheritance and data limitations.', robots: 'index,follow' },
